...
<template>
  <CommonModal :modal-style="{ 'background-color': 'white', ...props.modalStyle }" ref="modalRef" :show-close="false">
    <div class="dialog">
      ...
      <hr />
      <footer>
        <CusButton text="取消" type="normal" @click="handleCancel" v-bind="props.cancelButtonProps" />
        <CusButton text="确认" type="primary" @click="handleConfirm" v-bind="props.confirmButtonProps" />
      </footer>
    </div>
  </CommonModal>
</template>
